...
function child_chart() {
    ...
    // read in data from csv file
    d3.csv("demographicPopulation.csv", function (d) {
        return {
        date: parseTime(d.year),
        f04: +d.f04,
        f511: +d.f511,
        ...
        var dataset = data;
        lineChart(dataset);
        console.table(dataset, ["date", "f04", "f511", "f1217",
                                "f1859", "f60", "fother", "m04",
                                "m511", "m1217", "m1859", "m60", "mother" ]);
    });
    ...
    var lineChart = function (dataset) {
        ...
        xScale = d3.scaleTime()
            ...
            .domain([0, d3.max(dataset, function(d)
                {
                    return d.f04 + d.f511 + d.f1217 + d.f1859
                           + d.f1859 + d.f60 + d.fother + d.m04 + d.m511
                           + d.m1217 + d.m1859 + d.m60 + d.mother + padding;
                })
            ])
            .range([h, 0]);
